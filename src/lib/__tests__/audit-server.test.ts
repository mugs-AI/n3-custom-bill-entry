...
describe("acceptance fixture: 4 PIs, 24 rows, balanced 28,673.12 each side", () => {
  ...
  // Per-account debit/credit rows. Amounts are chosen so each PI balances
  // and posting-account totals match the acceptance table exactly.
  const debitRowsByAcct: Record<string, GLRow[]> = {
    ...
    "150-0200": [
      { docCode: "M1B2607001", accountCode: "150-0200", accountName: "DISCOUNT ALLOWED", debitLocal: 200, creditLocal: 0 },
    ],
    "201-0002": [
    ...
    "300-0400": [
      { docCode: "M1B2607003", accountCode: "300-0400", accountName: "DIVIDEND RECEIVED", debitLocal: 2093, creditLocal: 0 },
    ],
    "300-0500": [
      { docCode: "M1B2607003", accountCode: "300-0500", accountName: "FIXED DEPOSIT INTEREST", debitLocal: 3690, creditLocal: 0 },
      { docCode: "M1B2607003", accountCode: "300-0500", accountName: "FIXED DEPOSIT INTEREST", debitLocal: 3690, creditLocal: 0 },
    ],
    "300-2000": [
      { docCode: "M1B2607003", accountCode: "300-2000", accountName: "OTHER INCOME", debitLocal: 1196, creditLocal: 0 },
    ],
    "300-9000": [
    ...
    "SST-3000": [
      { docCode: "M1B2607001", accountCode: "SST-3000", accountName: "SST PURCHASE TAX", debitLocal: 200, creditLocal: 0 },
      { docCode: "M1B2607001", accountCode: "SST-3000", accountName: "SST PURCHASE TAX", debitLocal: 200, creditLocal: 0 },
      { docCode: "M1B2607001", accountCode: "SST-3000", accountName: "SST PURCHASE TAX", debitLocal: 165, creditLocal: 0 },
    ],
    "SST-4000": [
      // Three debit rows (296 + 63.12 = 359.12) plus two blank-docCode
      // continuation credits (167.44 + 95.68 = 263.12) that must resolve
      // to M1B2607003 via supplierInvNo + docDate.
      { docCode: "M1B2607001", accountCode: "SST-4000", accountName: "SST EXPENSES SERVICE TAX", debitLocal: 200, creditLocal: 0 },
      { docCode: "M1B2607001", accountCode: "SST-4000", accountName: "SST EXPENSES SERVICE TAX", debitLocal: 96, creditLocal: 0 },
      { docCode: "M1B2607003", accountCode: "SST-4000", accountName: "SST EXPENSES SERVICE TAX", debitLocal: 63.12, creditLocal: 0 },
